...
import com.gemframework.modules.extend.novel.mapper.NovelVoteMapper;
...
@Slf4j
@Service
public class NovelVoteServiceImpl extends ServiceImpl<NovelVoteMapper, NovelVote> implements NovelVoteService {
